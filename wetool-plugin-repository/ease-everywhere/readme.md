...
最新下载地址：[wetool-plugin-everywhere-1.1.2.jar](http://share.qiniu.segocat.com/tool/wetool/plugin/wetool-plugin-everywhere-1.1.2.jar)
...
#### [v1.1.2](http://share.qiniu.segocat.com/tool/wetool/plugin/wetool-plugin-everywhere-1.1.2.jar)
